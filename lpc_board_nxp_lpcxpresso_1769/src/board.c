...
#define LEDR_GPIO_PORT_NUM                      0
#define LEDR_GPIO_BIT_NUM                       22
...
static void Board_LED_Init(void)
{
	...
	Chip_GPIO_WriteDirBit(LPC_GPIO, LEDR_GPIO_PORT_NUM, LEDR_GPIO_BIT_NUM, true);
	Chip_GPIO_WriteDirBit(LPC_GPIO, LEDG_GPIO_PORT_NUM, LEDG_GPIO_BIT_NUM, true);
	Chip_GPIO_WriteDirBit(LPC_GPIO, LEDB_GPIO_PORT_NUM, LEDB_GPIO_BIT_NUM, true);
}
...
void Board_LED_Set(rgb_led_t LEDNumber, bool On)
{
	switch(LEDNumber) {
	case LED_RED:
	{
		Chip_GPIO_WritePortBit(LPC_GPIO, LEDR_GPIO_PORT_NUM, LEDR_GPIO_BIT_NUM, On);
		break;
	}
	case LED_GREEN:
	{
		Chip_GPIO_WritePortBit(LPC_GPIO, LEDG_GPIO_PORT_NUM, LEDG_GPIO_BIT_NUM, On);
		break;
	}
	case LED_BLUE:
	{
		Chip_GPIO_WritePortBit(LPC_GPIO, LEDB_GPIO_PORT_NUM, LEDB_GPIO_BIT_NUM, On);
		break;
	}
	}
}
...
bool Board_LED_Test(rgb_led_t LEDNumber)
{
	bool state = false;
	...
	case LED_RED:
	{
		state = Chip_GPIO_ReadPortBit(LPC_GPIO, LEDR_GPIO_PORT_NUM, LEDR_GPIO_BIT_NUM);
		break;
	}
	case LED_GREEN:
	{
		state = Chip_GPIO_ReadPortBit(LPC_GPIO, LEDG_GPIO_PORT_NUM, LEDG_GPIO_BIT_NUM);
		break;
	}
	case LED_BLUE:
	{
		state = Chip_GPIO_ReadPortBit(LPC_GPIO, LEDB_GPIO_PORT_NUM, LEDB_GPIO_BIT_NUM);
		break;
	}
	}
...
void Board_LED_Toggle(rgb_led_t LEDNumber)
{
//	if (LEDNumber == 0) {
